export default function Team(){
    return(
        <section className="py-6 dark:bg-transparency dark:text-gray-900">
	<div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
		...
		<div className="flex flex-row flex-wrap-reverse justify-center mt-8">
			<div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-teal-300 dark:text-gray-800">
				...
				<div className="flex-1 my-4">
					<p className="text-xl font-semibold leading-snug">Adrian Mvungi</p>
			...
			<div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-teal-300 dark:text-gray-800">
				...
				<div className="flex-1 my-4">
					<p className="text-xl font-semibold leading-snug">Alexanda Mrema</p>
					<p>CTO at Oceanware</p>
				</div>
				<div className="flex items-center justify-center p-3 space-x-3 border-t-2">
					<a rel="noopener noreferrer" href="#" title="Email" className="dark:text-gray-900 hover:dark:text-violet-400">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
			...
			<div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-teal-300 dark:text-gray-800">
				...
				<div className="flex-1 my-4">
					<p className="text-xl font-semibold leading-snug">Adam Andrea</p>
					<p>CEO at Oceanware</p>
				</div>
				<div className="flex items-center justify-center p-3 space-x-3 border-t-2">
					<a rel="noopener noreferrer" href="#" title="Email" className="dark:text-gray-900 hover:dark:text-violet-400">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
